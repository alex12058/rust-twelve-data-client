...
------------ | ------------- | ------------- | -------------
**date** | Option<**String**> | Date of the earnings estimate | [optional]
...
**year_ago_eps** | Option<**f64**> | Average estimation of this period's earnings given a year ago | [optional]

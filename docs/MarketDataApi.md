...
> models::GetCurrencyConversionResponse get_currency_conversion(symbol, amount, date, format, delimiter, dp, timezone)
Currency conversion
...
[**models::GetCurrencyConversionResponse**](GetCurrencyConversion_response.md)
...
> models::GetEodResponse get_eod(symbol, figi, isin, cusip, exchange, mic_code, country, r#type, date, prepost, dp)
End of day price
...
[**models::GetEodResponse**](GetEod_response.md)
...
> models::GetExchangeRateResponse get_exchange_rate(symbol, date, format, delimiter, dp, timezone)
Exchange rate
...
[**models::GetExchangeRateResponse**](GetExchangeRate_response.md)
...
> models::GetMarketMoversResponse get_market_movers(market, direction, outputsize, country, price_greater_than, dp)
Market movers
...
[**models::GetMarketMoversResponse**](GetMarketMovers_response.md)
...
> models::GetPriceResponse get_price(symbol, figi, isin, cusip, exchange, mic_code, country, r#type, format, delimiter, prepost, dp)
Latest price
...
[**models::GetPriceResponse**](GetPrice_response.md)
...
> models::GetQuoteResponse get_quote(symbol, figi, isin, cusip, interval, exchange, mic_code, country, volume_time_period, r#type, format, delimiter, prepost, eod, rolling_period, dp, timezone)
Quote
...
[**models::GetQuoteResponse**](GetQuote_response.md)

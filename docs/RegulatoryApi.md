...
> models::GetDirectHoldersResponse get_direct_holders(symbol, figi, isin, cusip, exchange, mic_code, country)
Direct holders
...
[**models::GetDirectHoldersResponse**](GetDirectHolders_response.md)
...
> models::GetFundHoldersResponse get_fund_holders(symbol, figi, isin, cusip, exchange, mic_code, country)
Fund holders
...
[**models::GetFundHoldersResponse**](GetFundHolders_response.md)
...
> models::GetInsiderTransactionsResponse get_insider_transactions(symbol, figi, isin, cusip, exchange, mic_code, country)
Insider transaction
...
[**models::GetInsiderTransactionsResponse**](GetInsiderTransactions_response.md)
...
> models::GetInstitutionalHoldersResponse get_institutional_holders(symbol, figi, isin, cusip, exchange, mic_code, country)
...
[**models::GetInstitutionalHoldersResponse**](GetInstitutionalHolders_response.md)
...
> models::GetSourceSanctionedEntitiesResponse get_source_sanctioned_entities(source)
Sanctioned entities
...
[**models::GetSourceSanctionedEntitiesResponse**](GetSourceSanctionedEntities_response.md)
...
> models::GetTaxInfoResponse get_tax_info(symbol, isin, figi, cusip, exchange, mic_code)
Tax information
...
[**models::GetTaxInfoResponse**](GetTaxInfo_response.md)

...
> models::AdvancedResponse advanced(key)
Batches
...
[**models::AdvancedResponse**](advanced_response.md)
...
> models::GetApiUsageResponse get_api_usage(format, delimiter, timezone)
API usage
...
[**models::GetApiUsageResponse**](GetApiUsage_response.md)

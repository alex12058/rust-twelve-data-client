...
**fast_ma_type** | Option<**String**> | The type of fast moving average used in the calculation | [optional]
**slow_period** | Option<**i64**> | The longer time period for calculation | [optional]
**slow_ma_type** | Option<**String**> | The type of slow moving average used in the calculation | [optional]
**signal_period** | Option<**i64**> | The time period used for generating the signal line | [optional]
**signal_ma_type** | Option<**String**> | The type of moving average used for generating the signal line | [optional]

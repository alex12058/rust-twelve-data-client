...
pub async fn get_mutual_funds_world_composition(
    configuration: &configuration::Configuration,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetMutualFundsWorldCompositionError> =
...
pub async fn get_mutual_funds_world_performance(
    configuration: &configuration::Configuration,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetMutualFundsWorldPerformanceError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn get_mutual_funds_world_purchase_info(
    configuration: &configuration::Configuration,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetMutualFundsWorldPurchaseInfoError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn get_mutual_funds_world_sustainability(
    configuration: &configuration::Configuration,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetMutualFundsWorldSustainabilityError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,

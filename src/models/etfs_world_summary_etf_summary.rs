...
/// EtfsWorldSummaryEtfSummary : A brief summary of a ETF
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EtfsWorldSummaryEtfSummary {
...
impl EtfsWorldSummaryEtfSummary {
    /// A brief summary of a ETF
    pub fn new() -> EtfsWorldSummaryEtfSummary {
        EtfsWorldSummaryEtfSummary {
            symbol: None,
            name: None,
            fund_family: None,
            fund_type: None,

...
pub struct AssetsInfoNonCurrentAssets {
    ...
    #[serde(
        rename = "total_non_current_assets",
    ...
    #[serde(
        rename = "investments_and_advances",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "long_term_equity_investment",
        skip_serializing_if = "Option::is_none"
    )]
    pub long_term_equity_investment: Option<f64>,
    /// Investments in joint ventures at cost
    #[serde(
        rename = "investments_in_joint_ventures_at_cost",
        skip_serializing_if = "Option::is_none"
    )]
    pub investments_in_joint_ventures_at_cost: Option<f64>,
    /// Investments in other ventures under equity method
    #[serde(
        rename = "investments_in_other_ventures_under_equity_method",
        skip_serializing_if = "Option::is_none"
    )]
    pub investments_in_other_ventures_under_equity_method: Option<f64>,
    /// Investments in associates at cost
    #[serde(
        rename = "investments_in_associates_at_cost",
        skip_serializing_if = "Option::is_none"
    )]
    pub investments_in_associates_at_cost: Option<f64>,
    /// Investments in subsidiaries at cost
    #[serde(
        rename = "investments_in_subsidiaries_at_cost",
        skip_serializing_if = "Option::is_none"
    )]
    pub investments_in_subsidiaries_at_cost: Option<f64>,
    /// Investment properties
    #[serde(
        rename = "investment_properties",
        skip_serializing_if = "Option::is_none"
    )]
    pub investment_properties: Option<f64>,
    #[serde(
        rename = "goodwill_and_other_intangible_assets",
        skip_serializing_if = "Option::is_none"
    )]
    pub goodwill_and_other_intangible_assets:
        Option<Box<models::AssetsInfoNonCurrentAssetsGoodwillAndOtherIntangibleAssets>>,
    /// Net ppe
    ...
    #[serde(
        rename = "accumulated_depreciation",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "construction_in_progress",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "machinery_furniture_equipment",
        skip_serializing_if = "Option::is_none"
    )]
    pub machinery_furniture_equipment: Option<f64>,
    /// Buildings and improvements
    #[serde(
        rename = "buildings_and_improvements",
        skip_serializing_if = "Option::is_none"
    )]
    pub buildings_and_improvements: Option<f64>,
    /// Land and improvements
    #[serde(
        rename = "land_and_improvements",
        skip_serializing_if = "Option::is_none"
    )]

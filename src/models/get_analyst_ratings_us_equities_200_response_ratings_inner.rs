...
pub struct GetAnalystRatingsUsEquities200ResponseRatingsInner {
    ...
    /// Name of an analyst
    #[serde(rename = "analyst_name", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "rating_change", skip_serializing_if = "Option::is_none")]
    pub rating_change: Option<String>,
    /// Current firm's ranking of the instrument
    #[serde(rename = "rating_current", skip_serializing_if = "Option::is_none")]
    pub rating_current: Option<String>,
    /// Prior firm's ranking of the instrument
    #[serde(rename = "rating_prior", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "action_price_target", skip_serializing_if = "Option::is_none")]
    pub action_price_target: Option<String>,
    /// Current firm's price target for the instrument
    #[serde(rename = "price_target_current", skip_serializing_if = "Option::is_none")]
    pub price_target_current: Option<f64>,
    /// Prior firm's price target for the instrument
    #[serde(rename = "price_target_prior", skip_serializing_if = "Option::is_none")]
    pub price_target_prior: Option<f64>,
}

impl GetAnalystRatingsUsEquities200ResponseRatingsInner {
    pub fn new() -> GetAnalystRatingsUsEquities200ResponseRatingsInner {

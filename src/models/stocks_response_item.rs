...
pub struct StocksResponseItem {
    ...
    #[serde(rename = "figi_code", skip_serializing_if = "Option::is_none")]
    ...
    pub access: Option<Box<models::EtfResponseItemAccess>>,
}

impl StocksResponseItem {
    /// StocksResponseItem represents details of a stock instrument
    pub fn new() -> StocksResponseItem {
        StocksResponseItem {
            symbol: None,
            name: None,
            currency: None,

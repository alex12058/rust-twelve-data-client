...
/// StatisticsStatisticsFinancialsIncomeStatement : Income statement information
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct StatisticsStatisticsFinancialsIncomeStatement {
    /// Refers to total revenue over the last 12 months
    #[serde(rename = "revenue_ttm", skip_serializing_if = "Option::is_none")]
    pub revenue_ttm: Option<f64>,
    /// Refers to revenue per share over the last 12 months
    #[serde(
        rename = "revenue_per_share_ttm",
        skip_serializing_if = "Option::is_none"
    )]
    pub revenue_per_share_ttm: Option<f64>,
    /// Refers to quarterly revenue growth year over year
    #[serde(
        rename = "quarterly_revenue_growth",
        skip_serializing_if = "Option::is_none"
    )]
    pub quarterly_revenue_growth: Option<f64>,
    /// Refers to gross profit over the last 12 months
    #[serde(rename = "gross_profit_ttm", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(
        rename = "net_income_to_common_ttm",
        skip_serializing_if = "Option::is_none"
    )]
    pub net_income_to_common_ttm: Option<f64>,
    /// Refers to diluted EPS measure over the last 12 months
    #[serde(rename = "diluted_eps_ttm", skip_serializing_if = "Option::is_none")]
    pub diluted_eps_ttm: Option<f64>,
    /// Refers to quarterly earnings growth year over year
    #[serde(
        rename = "quarterly_earnings_growth_yoy",
        skip_serializing_if = "Option::is_none"
    )]
    pub quarterly_earnings_growth_yoy: Option<f64>,
}

impl StatisticsStatisticsFinancialsIncomeStatement {
    /// Income statement information
    pub fn new() -> StatisticsStatisticsFinancialsIncomeStatement {

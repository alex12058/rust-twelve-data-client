...
pub struct GetEarningsCalendar200ResponseEarningsValueInner {
    ...
    #[serde(rename = "eps_estimate", skip_serializing_if = "Option::is_none")]
    pub eps_estimate: Option<f64>,
    /// Actual value of reported earning
    #[serde(rename = "eps_actual", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "surprise_prc", skip_serializing_if = "Option::is_none")]
    pub surprise_prc: Option<f64>,
}

impl GetEarningsCalendar200ResponseEarningsValueInner {
    pub fn new() -> GetEarningsCalendar200ResponseEarningsValueInner {

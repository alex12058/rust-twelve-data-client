...
pub struct OptionSide {
    ...
    #[serde(rename = "implied_volatility", skip_serializing_if = "Option::is_none")]
    pub implied_volatility: Option<f64>,
    #[serde(rename = "in_the_money", skip_serializing_if = "Option::is_none")]
    pub in_the_money: Option<bool>,
    #[serde(rename = "last_price", skip_serializing_if = "Option::is_none")]
    pub last_price: Option<f64>,
    #[serde(rename = "last_trade_date", skip_serializing_if = "Option::is_none")]

...
pub struct IncomeStatementBlock {
    ...
    #[serde(rename = "cost_of_goods", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "operating_expense", skip_serializing_if = "Option::is_none")]
    pub operating_expense: Option<Box<models::IncomeStatementBlockOperatingExpense>>,
    ...
    #[serde(rename = "non_operating_interest", skip_serializing_if = "Option::is_none")]
    pub non_operating_interest: Option<Box<models::IncomeStatementBlockNonOperatingInterest>>,
    ...
    #[serde(rename = "income_tax", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "eps_diluted", skip_serializing_if = "Option::is_none")]
    pub eps_diluted: Option<f64>,
    /// Refers for the shares outstanding held by all its shareholders
    #[serde(rename = "basic_shares_outstanding", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "diluted_shares_outstanding", skip_serializing_if = "Option::is_none")]
    pub diluted_shares_outstanding: Option<i64>,
    /// Refers to earnings before interest and taxes (EBIT) measure
    #[serde(rename = "ebit", skip_serializing_if = "Option::is_none")]
    pub ebit: Option<i64>,
    ...
    #[serde(rename = "preferred_stock_dividends", skip_serializing_if = "Option::is_none")]

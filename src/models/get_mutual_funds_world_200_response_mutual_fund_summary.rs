...
pub struct GetMutualFundsWorld200ResponseMutualFundSummary {
    ...
    #[serde(rename = "share_class_inception_date", skip_serializing_if = "Option::is_none")]
...
impl GetMutualFundsWorld200ResponseMutualFundSummary {
    /// A brief summary of a mutual fund
    pub fn new() -> GetMutualFundsWorld200ResponseMutualFundSummary {

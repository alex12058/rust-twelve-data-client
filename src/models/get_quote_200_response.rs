...
pub struct GetQuote200Response {
    /// Symbol passed
    ...
    #[serde(rename = "mic_code", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "last_quote_at", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "previous_close", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "average_volume", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "rolling_1d_change", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "rolling_7d_change", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "rolling_change", skip_serializing_if = "Option::is_none")]
    pub rolling_change: Option<String>,
    /// True if market is open; false if closed
    #[serde(rename = "is_market_open", skip_serializing_if = "Option::is_none")]
    pub is_market_open: Option<bool>,
    #[serde(rename = "fifty_two_week", skip_serializing_if = "Option::is_none")]
    pub fifty_two_week: Option<Box<models::GetQuote200ResponseFiftyTwoWeek>>,
    /// Diff between the regular close price and the latest extended price. Displayed only if prepost is true
    #[serde(rename = "extended_change", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "extended_percent_change", skip_serializing_if = "Option::is_none")]
    pub extended_percent_change: Option<String>,
    /// Latest extended price. Displayed only if prepost is true
    #[serde(rename = "extended_price", skip_serializing_if = "Option::is_none")]
    pub extended_price: Option<String>,
    /// Unix timestamp of the last extended price. Displayed only if prepost is true
    #[serde(rename = "extended_timestamp", skip_serializing_if = "Option::is_none")]
    pub extended_timestamp: Option<String>,
}

impl GetQuote200Response {
    pub fn new() -> GetQuote200Response {
        GetQuote200Response {
            symbol: None,
            name: None,
            exchange: None,

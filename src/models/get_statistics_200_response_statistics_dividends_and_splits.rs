...
pub struct GetStatistics200ResponseStatisticsDividendsAndSplits {
    /// Refers to the forward dividend yield estimation in the currency of instrument
    #[serde(rename = "forward_annual_dividend_rate", skip_serializing_if = "Option::is_none")]
    pub forward_annual_dividend_rate: Option<f64>,
    /// Refers to the forward dividend yield percentage relative to stock price
    #[serde(rename = "forward_annual_dividend_yield", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "trailing_annual_dividend_rate", skip_serializing_if = "Option::is_none")]
    pub trailing_annual_dividend_rate: Option<f64>,
    /// Refers to the trailing dividend yield percentage relative to stock price
    #[serde(rename = "trailing_annual_dividend_yield", skip_serializing_if = "Option::is_none")]
    pub trailing_annual_dividend_yield: Option<f64>,
    /// Refers to the average 5 years dividend yield
    #[serde(rename = "5_year_average_dividend_yield", skip_serializing_if = "Option::is_none")]
    pub param_5_year_average_dividend_yield: Option<f64>,
    /// Refers to payout ratio, showing the proportion of earnings a company pays its shareholders in the form of dividends
    #[serde(rename = "payout_ratio", skip_serializing_if = "Option::is_none")]
    pub payout_ratio: Option<f64>,
    /// Refers to how often a stock or fund pays dividends
    #[serde(rename = "dividend_frequency", skip_serializing_if = "Option::is_none")]
    pub dividend_frequency: Option<String>,
    /// Refers to the last dividend payout date
    #[serde(rename = "dividend_date", skip_serializing_if = "Option::is_none")]
    pub dividend_date: Option<String>,
    /// Refers to the last ex-dividend payout date
    #[serde(rename = "ex_dividend_date", skip_serializing_if = "Option::is_none")]
    pub ex_dividend_date: Option<String>,
    /// Specification of the last split event
    #[serde(rename = "last_split_factor", skip_serializing_if = "Option::is_none")]
    pub last_split_factor: Option<String>,
    /// Refers for the last split date
    #[serde(rename = "last_split_date", skip_serializing_if = "Option::is_none")]
    pub last_split_date: Option<String>,
}

impl GetStatistics200ResponseStatisticsDividendsAndSplits {
    /// Dividends and splits information of the company
    pub fn new() -> GetStatistics200ResponseStatisticsDividendsAndSplits {
        GetStatistics200ResponseStatisticsDividendsAndSplits {
            ...
            param_5_year_average_dividend_yield: None,
            payout_ratio: None,

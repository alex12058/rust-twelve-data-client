...
pub struct MutualFundsListResponseListItem {
    /// Fund symbol ticker
    ...
    #[serde(rename = "performance_rating", skip_serializing_if = "Option::is_none")]
    pub performance_rating: Option<i64>,
    /// Risk rating from `0` to `5`
    #[serde(rename = "risk_rating", skip_serializing_if = "Option::is_none")]
...
impl MutualFundsListResponseListItem {
    pub fn new() -> MutualFundsListResponseListItem {

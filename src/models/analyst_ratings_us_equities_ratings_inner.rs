...
pub struct AnalystRatingsUsEquitiesRatingsInner {
...
impl AnalystRatingsUsEquitiesRatingsInner {
    pub fn new() -> AnalystRatingsUsEquitiesRatingsInner {
        AnalystRatingsUsEquitiesRatingsInner {
            date: None,
            firm: None,
            analyst_name: None,
            rating_change: None,

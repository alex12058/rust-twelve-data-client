...
/// MutualFundsWorldMutualFundSummary : A brief summary of a mutual fund
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MutualFundsWorldMutualFundSummary {
    ...
    #[serde(rename = "fund_family", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(
        rename = "share_class_inception_date",
        skip_serializing_if = "Option::is_none"
    )]
    pub share_class_inception_date: Option<String>,
    /// Percentage of profit of the fund since the first trading day of the current calendar year
    #[serde(rename = "ytd_return", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "expense_ratio_net", skip_serializing_if = "Option::is_none")]
    pub expense_ratio_net: Option<f64>,
    ...
    pub nav: Option<f64>,
    /// Investment minimum
    #[serde(rename = "min_investment", skip_serializing_if = "Option::is_none")]
    pub min_investment: Option<i64>,
    /// Percentage rate at which mutual fund replaces its holdings on investment every year
    #[serde(rename = "turnover_rate", skip_serializing_if = "Option::is_none")]
    pub turnover_rate: Option<f64>,
    /// Total assets of a fund minus its total liabilities
    #[serde(rename = "net_assets", skip_serializing_if = "Option::is_none")]
...
impl MutualFundsWorldMutualFundSummary {
    /// A brief summary of a mutual fund
    pub fn new() -> MutualFundsWorldMutualFundSummary {
        MutualFundsWorldMutualFundSummary {
            symbol: None,
            name: None,
            fund_family: None,
            fund_type: None,
            currency: None,
            share_class_inception_date: None,
            ytd_return: None,

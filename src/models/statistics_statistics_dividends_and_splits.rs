...
impl StatisticsStatisticsDividendsAndSplits {
    /// Dividends and splits information of the company
    pub fn new() -> StatisticsStatisticsDividendsAndSplits {
        StatisticsStatisticsDividendsAndSplits {

...
pub struct CashFlowStructInvestingActivities {
    /// Capital expenditures (CapEx) are funds used by a company to acquire, upgrade, and maintain physical assets (PPE)
    #[serde(
        rename = "capital_expenditures",
        skip_serializing_if = "Option::is_none"
    )]
    pub capital_expenditures: Option<f64>,
    /// Represents purchase of a not physical asset
    #[serde(rename = "net_intangibles", skip_serializing_if = "Option::is_none")]
    pub net_intangibles: Option<f64>,
    /// Refers to net amount of business purchase and sale
    #[serde(rename = "net_acquisitions", skip_serializing_if = "Option::is_none")]
    pub net_acquisitions: Option<f64>,
    ...
    #[serde(
        rename = "purchase_of_investments",
        skip_serializing_if = "Option::is_none"
    )]
    pub purchase_of_investments: Option<f64>,
    /// Represents how much money has been generated from the sale of securities or assets
    #[serde(
        rename = "sale_of_investments",
        skip_serializing_if = "Option::is_none"
    )]
    pub sale_of_investments: Option<f64>,
    /// Represents other investing activity
    #[serde(
        rename = "other_investing_activity",
        skip_serializing_if = "Option::is_none"
    )]
    pub other_investing_activity: Option<f64>,
...
impl CashFlowStructInvestingActivities {
    /// Investing activities section
    pub fn new() -> CashFlowStructInvestingActivities {
        CashFlowStructInvestingActivities {
            capital_expenditures: None,
            net_intangibles: None,
            net_acquisitions: None,
            purchase_of_investments: None,
            sale_of_investments: None,
            other_investing_activity: None,

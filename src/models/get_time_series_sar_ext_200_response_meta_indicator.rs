...
pub struct GetTimeSeriesSarExt200ResponseMetaIndicator {
...
impl GetTimeSeriesSarExt200ResponseMetaIndicator {
    /// Technical indicator information
    pub fn new() -> GetTimeSeriesSarExt200ResponseMetaIndicator {

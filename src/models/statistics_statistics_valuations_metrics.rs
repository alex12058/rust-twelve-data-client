...
/// StatisticsStatisticsValuationsMetrics : Valuation metrics of the company
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct StatisticsStatisticsValuationsMetrics {
    /// Refers to the market value of the company's outstanding shares
    #[serde(
        rename = "market_capitalization",
    ...
    #[serde(rename = "enterprise_value", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "trailing_pe", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "forward_pe", skip_serializing_if = "Option::is_none")]
    pub forward_pe: Option<f64>,
    /// The price/earnings to growth (PEG) ratio is a price-to-earnings ratio divided by the growth rate of the earnings
    #[serde(rename = "peg_ratio", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "price_to_sales_ttm", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "price_to_book_mrq", skip_serializing_if = "Option::is_none")]
    pub price_to_book_mrq: Option<f64>,
    /// The enterprise value-to-revenue multiple (EV/R) is a measure that compares enterprise value to revenue
    #[serde(
        rename = "enterprise_to_revenue",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "enterprise_to_ebitda",
        skip_serializing_if = "Option::is_none"
    )]
    pub enterprise_to_ebitda: Option<f64>,
}

impl StatisticsStatisticsValuationsMetrics {
    /// Valuation metrics of the company
    pub fn new() -> StatisticsStatisticsValuationsMetrics {

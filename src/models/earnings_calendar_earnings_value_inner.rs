...
pub struct EarningsCalendarEarningsValueInner {
...
impl EarningsCalendarEarningsValueInner {
    pub fn new() -> EarningsCalendarEarningsValueInner {
        EarningsCalendarEarningsValueInner {
            symbol: None,
            name: None,
            currency: None,
            exchange: None,

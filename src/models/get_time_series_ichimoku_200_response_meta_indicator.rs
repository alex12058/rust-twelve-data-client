...
pub struct GetTimeSeriesIchimoku200ResponseMetaIndicator {
...
impl GetTimeSeriesIchimoku200ResponseMetaIndicator {
    /// Technical indicator information
    pub fn new() -> GetTimeSeriesIchimoku200ResponseMetaIndicator {

...
pub struct CashFlowStruct {
    ...
    pub year: Option<i64>,
    #[serde(
        rename = "operating_activities",
        skip_serializing_if = "Option::is_none"
    )]
    pub operating_activities: Option<Box<models::CashFlowStructOperatingActivities>>,
    #[serde(
        rename = "investing_activities",
        skip_serializing_if = "Option::is_none"
    )]
    pub investing_activities: Option<Box<models::CashFlowStructInvestingActivities>>,
    #[serde(
        rename = "financing_activities",
        skip_serializing_if = "Option::is_none"
    )]
    pub financing_activities: Option<Box<models::CashFlowStructFinancingActivities>>,
    ...
    #[serde(rename = "income_tax_paid", skip_serializing_if = "Option::is_none")]

...
pub struct GetBalanceSheet200ResponseBalanceSheetInnerAssetsCurrentAssets {
    ...
    #[serde(rename = "assets_held_for_sale", skip_serializing_if = "Option::is_none")]
    pub assets_held_for_sale: Option<f64>,
    /// Represents money that is spent on hedging assets
    #[serde(rename = "hedging_assets", skip_serializing_if = "Option::is_none")]
    pub hedging_assets: Option<f64>,
...
impl GetBalanceSheet200ResponseBalanceSheetInnerAssetsCurrentAssets {
    /// Current assets section
    pub fn new() -> GetBalanceSheet200ResponseBalanceSheetInnerAssetsCurrentAssets {

...
/// BalanceSheetBalanceSheetInnerAssetsNonCurrentAssets : Non-current assets section
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct BalanceSheetBalanceSheetInnerAssetsNonCurrentAssets {
    ...
    #[serde(rename = "goodwill", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "intangible_assets", skip_serializing_if = "Option::is_none")]
...
impl BalanceSheetBalanceSheetInnerAssetsNonCurrentAssets {
    /// Non-current assets section
    pub fn new() -> BalanceSheetBalanceSheetInnerAssetsNonCurrentAssets {
        BalanceSheetBalanceSheetInnerAssetsNonCurrentAssets {
            properties: None,

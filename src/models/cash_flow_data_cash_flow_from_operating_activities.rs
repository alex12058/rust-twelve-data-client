...
pub struct CashFlowDataCashFlowFromOperatingActivities {
    ...
    #[serde(rename = "net_income_from_continuing_operations", skip_serializing_if = "Option::is_none")]
    pub net_income_from_continuing_operations: Option<f64>,
    /// Operating cash flow
    #[serde(rename = "operating_cash_flow", skip_serializing_if = "Option::is_none")]
    pub operating_cash_flow: Option<f64>,
    /// Cash flow from continuing operating activities
    #[serde(rename = "cash_flow_from_continuing_operating_activities", skip_serializing_if = "Option::is_none")]
    pub cash_flow_from_continuing_operating_activities: Option<f64>,
    /// Cash from discontinued operating activities
    #[serde(rename = "cash_from_discontinued_operating_activities", skip_serializing_if = "Option::is_none")]
    pub cash_from_discontinued_operating_activities: Option<f64>,
    /// Cash flow from discontinued operation
    #[serde(rename = "cash_flow_from_discontinued_operation", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "cash_flows_from_used_in_operating_activities_direct", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "taxes_refund_paid_direct", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "interest_received_direct", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "interest_paid_direct", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "dividend_received_direct", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "dividend_paid_direct", skip_serializing_if = "Option::is_none")]
    pub dividend_paid_direct: Option<f64>,
    /// Change in working capital
    #[serde(rename = "change_in_working_capital", skip_serializing_if = "Option::is_none")]
    pub change_in_working_capital: Option<f64>,
    /// Change in other working capital
    #[serde(rename = "change_in_other_working_capital", skip_serializing_if = "Option::is_none")]
    pub change_in_other_working_capital: Option<f64>,
    /// Change in receivables
    #[serde(rename = "change_in_receivables", skip_serializing_if = "Option::is_none")]
    pub change_in_receivables: Option<f64>,
    /// Changes in account receivables
    #[serde(rename = "changes_in_account_receivables", skip_serializing_if = "Option::is_none")]
    pub changes_in_account_receivables: Option<f64>,
    /// Change in payables and accrued expense
    #[serde(rename = "change_in_payables_and_accrued_expense", skip_serializing_if = "Option::is_none")]
    pub change_in_payables_and_accrued_expense: Option<f64>,
    /// Change in accrued expense
    #[serde(rename = "change_in_accrued_expense", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "change_in_dividend_payable", skip_serializing_if = "Option::is_none")]
    pub change_in_dividend_payable: Option<f64>,
    /// Change in account payable
    #[serde(rename = "change_in_account_payable", skip_serializing_if = "Option::is_none")]
    pub change_in_account_payable: Option<f64>,
    /// Change in tax payable
    #[serde(rename = "change_in_tax_payable", skip_serializing_if = "Option::is_none")]
    pub change_in_tax_payable: Option<f64>,
    /// Change in income tax payable
    #[serde(rename = "change_in_income_tax_payable", skip_serializing_if = "Option::is_none")]
    pub change_in_income_tax_payable: Option<f64>,
    /// Change in interest payable
    #[serde(rename = "change_in_interest_payable", skip_serializing_if = "Option::is_none")]
    pub change_in_interest_payable: Option<f64>,
    /// Change in other current liabilities
    #[serde(rename = "change_in_other_current_liabilities", skip_serializing_if = "Option::is_none")]
    pub change_in_other_current_liabilities: Option<f64>,
    /// Change in other current assets
    #[serde(rename = "change_in_other_current_assets", skip_serializing_if = "Option::is_none")]
    pub change_in_other_current_assets: Option<f64>,
    /// Change in inventory
    #[serde(rename = "change_in_inventory", skip_serializing_if = "Option::is_none")]
    pub change_in_inventory: Option<f64>,
    /// Change in prepaid assets
    #[serde(rename = "change_in_prepaid_assets", skip_serializing_if = "Option::is_none")]
    pub change_in_prepaid_assets: Option<f64>,
    /// Other non cash items
    #[serde(rename = "other_non_cash_items", skip_serializing_if = "Option::is_none")]
    pub other_non_cash_items: Option<f64>,
    /// Excess tax benefit from stock based compensation
    #[serde(rename = "excess_tax_benefit_from_stock_based_compensation", skip_serializing_if = "Option::is_none")]
    pub excess_tax_benefit_from_stock_based_compensation: Option<f64>,
    /// Stock based compensation
    #[serde(rename = "stock_based_compensation", skip_serializing_if = "Option::is_none")]
    pub stock_based_compensation: Option<f64>,
    /// Unrealized gain loss on investment securities
    #[serde(rename = "unrealized_gain_loss_on_investment_securities", skip_serializing_if = "Option::is_none")]
    pub unrealized_gain_loss_on_investment_securities: Option<f64>,
    /// Provision and write off of assets
    #[serde(rename = "provision_and_write_off_of_assets", skip_serializing_if = "Option::is_none")]
    pub provision_and_write_off_of_assets: Option<f64>,
    /// Asset impairment charge
    #[serde(rename = "asset_impairment_charge", skip_serializing_if = "Option::is_none")]
    pub asset_impairment_charge: Option<f64>,
    /// Amortization of securities
    #[serde(rename = "amortization_of_securities", skip_serializing_if = "Option::is_none")]
    ...
    /// Deferred income tax
    #[serde(rename = "deferred_income_tax", skip_serializing_if = "Option::is_none")]
    pub deferred_income_tax: Option<f64>,
    /// Depreciation amortization depletion
    #[serde(rename = "depreciation_amortization_depletion", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "depreciation_and_amortization", skip_serializing_if = "Option::is_none")]
    pub depreciation_and_amortization: Option<f64>,
    /// Amortization cash flow
    #[serde(rename = "amortization_cash_flow", skip_serializing_if = "Option::is_none")]
    pub amortization_cash_flow: Option<f64>,
    /// Amortization of intangibles
    #[serde(rename = "amortization_of_intangibles", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "operating_gains_losses", skip_serializing_if = "Option::is_none")]
    pub operating_gains_losses: Option<f64>,
    /// Pension and employee benefit expense
    #[serde(rename = "pension_and_employee_benefit_expense", skip_serializing_if = "Option::is_none")]
    pub pension_and_employee_benefit_expense: Option<f64>,
    /// Earnings losses from equity investments
    #[serde(rename = "earnings_losses_from_equity_investments", skip_serializing_if = "Option::is_none")]
    pub earnings_losses_from_equity_investments: Option<f64>,
    /// Gain loss on investment securities
    #[serde(rename = "gain_loss_on_investment_securities", skip_serializing_if = "Option::is_none")]
    pub gain_loss_on_investment_securities: Option<f64>,
    /// Net foreign currency exchange gain loss
    #[serde(rename = "net_foreign_currency_exchange_gain_loss", skip_serializing_if = "Option::is_none")]
    pub net_foreign_currency_exchange_gain_loss: Option<f64>,
    /// Gain loss on sale of ppe
    #[serde(rename = "gain_loss_on_sale_of_ppe", skip_serializing_if = "Option::is_none")]
    pub gain_loss_on_sale_of_ppe: Option<f64>,
    /// Gain loss on sale of business
    #[serde(rename = "gain_loss_on_sale_of_business", skip_serializing_if = "Option::is_none")]

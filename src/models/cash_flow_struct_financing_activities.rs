...
pub struct CashFlowStructFinancingActivities {
    ...
    #[serde(
        rename = "common_stock_repurchase",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(rename = "common_dividends", skip_serializing_if = "Option::is_none")]
    pub common_dividends: Option<f64>,
    /// Represents other financing charges
    #[serde(
        rename = "other_financing_charges",
        skip_serializing_if = "Option::is_none"
    )]
...
impl CashFlowStructFinancingActivities {
    ...
    pub fn new() -> CashFlowStructFinancingActivities {
        CashFlowStructFinancingActivities {
            ...
            common_stock_repurchase: None,
            common_dividends: None,
            other_financing_charges: None,

...
pub struct IncomeStatementItemInterestIncomeAndExpense {
    /// Interest income
    #[serde(rename = "interest_income", skip_serializing_if = "Option::is_none")]
    pub interest_income: Option<f64>,
    /// Interest expense
    #[serde(rename = "interest_expense", skip_serializing_if = "Option::is_none")]
    pub interest_expense: Option<f64>,
    /// Net interest income
    #[serde(
        rename = "net_interest_income",
        skip_serializing_if = "Option::is_none"
    )]
    pub net_interest_income: Option<f64>,
    /// Net non operating interest income expense
    #[serde(
        rename = "net_non_operating_interest_income_expense",
        skip_serializing_if = "Option::is_none"
    )]
    pub net_non_operating_interest_income_expense: Option<f64>,
    /// Interest expense non operating
    #[serde(
        rename = "interest_expense_non_operating",
        skip_serializing_if = "Option::is_none"
    )]
    pub interest_expense_non_operating: Option<f64>,
    /// Interest income non operating
    #[serde(
        rename = "interest_income_non_operating",
        skip_serializing_if = "Option::is_none"
    )]
    pub interest_income_non_operating: Option<f64>,
}

impl IncomeStatementItemInterestIncomeAndExpense {
    /// Interest income and expense information
    pub fn new() -> IncomeStatementItemInterestIncomeAndExpense {
        IncomeStatementItemInterestIncomeAndExpense {
            ...
            interest_income_non_operating: None,
        }
    }
}
